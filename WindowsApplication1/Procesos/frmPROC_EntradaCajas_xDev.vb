...
Public Class frmPROC_EntradaCajas_xDev
    ...
    Private Sub frmPROC_EntradaCajas_xDev_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        'If iPrimeraVez Then
    ...
    Private Sub frmPROC_EntradaCajas_xDev_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Nuevo()
        Try
            ...
            lResp = MessageBox.Show("¿Deseas generar una devolución nueva?", gProyecto, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)
    ...
    End Sub
    Private Sub frmPROC_EntradaCajas_xDev_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'CARGA EL MOVIMIENTO ENTRADA CAJAS X DEVOLUCION
        oMovAlmacen = New clsMovimientoAlmacen(17)
    ...
    Private Sub Guardar()
        Try
            ...
            lOperacion = "4"    'ENTRADA DE CAJAS POR DEVOLUCION
    ...
    Private Sub DespliegaDatos_TMP()
        Try
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_TMP 17, " & oIntroductor.ID_ALM_CAJ.ToString & ", " & oDestino.ID_CLIENTE & "," & "0,0"
            ...
            Me.lblCanalesSalida.Text = "Cajas para la entrada" & " (" & Me.DsSacrificio.SP_CONS_ENTSAL_X_MOVTO_TMP.Rows.Count & ")"
    ...
    Private Function Valida_CodBar() As Boolean
        Try
            ...
            oCaja = New clsMovimientoEntSal(2, lCodBar)
    ...
    Private Sub EliminaCajaTemporal()
        Try
            ...
            lResp = MessageBox.Show("¿Estas seguro de eliminar esta caja de la entrada?", gProyecto, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)
            If lResp = MsgBoxResult.No Then
                Exit Sub
            End If
