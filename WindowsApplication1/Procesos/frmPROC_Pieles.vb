...
Public Class frmPROC_Pieles
    ...
    Private Sub frmPROC_Pieles_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAPRODUCTOR"
                lsTitulo = "CTE_PIELES_PRODUCTOR"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_PIELES_INTRODUCTOR"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTMARCADESTINO"
                lsTitulo = "CTE_PIELES_DESTINO"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
        End Select
    ...
    Private Sub frmPROC_Sacrificio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'CARGA EL MOVIMIENTO DE REGISTRO DE PESADA DE PIELES
        oMovAlmacen = New clsMovimientoAlmacen(3)
        ...
        If Not goPermisosValidaciones.PesadaManual_Pieles Then Me.txtPeso.ReadOnly = True
    ...
    Private Sub CargaProductos()
        Try
            ...
            ''Dim lID_Movto As Integer = 3    'ENTRADA PESADA PIELES
            ...
            With lCmd
                ...
                .CommandText = "Select * From productos WHERE nombre like 'PIEL%' ORDER BY ID_PROD"
                .Connection = Cnn
            End With
    ...
    Private Sub Guardar()
        Try
            ...
            oMovimientoEntSal.ID_ALM = oIntroductor.ID_ALM_PIEL
    ...
    Private Sub DespliegaDatos()
        ...
        If oMovimientoEntSal.ID_ESC <> 0 Then
            ...
            Me.DsSacrificio.SP_CONS_ENTSAL_ENCDET_X_FECHA_LOTE_PIEL.Clear()
            lSql = "SP_CONS_ENTSAL_ENCDET_X_FECHA_LOTE_PIEL 3, '" & oMovimientoEntSal.FECHA & "', " & oMovimientoEntSal.SAC_LOTE & ", '%'"
            ...
            da1.Fill(Me.DsSacrificio.SP_CONS_ENTSAL_ENCDET_X_FECHA_LOTE_PIEL)

            'If Me.DsSacrificio.SP_CONS_ENTSAL_ENCDET_X_FECHA_LOTE_PIEL.Rows.Count > 0 Then Me.FormatoGrid()
