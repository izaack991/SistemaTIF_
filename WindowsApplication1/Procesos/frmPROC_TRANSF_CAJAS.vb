...
Public Class frmPROC_TRANSF_CAJAS
    ...
    Public Sub New(bTransferencia As Boolean)
        ...
        Select Case aOpcion
            ...
            Case 2
                ...
                If oIntroductor.ID_CLIENTE <> 0 Then
                    llenaralmacenorigen(bTransferencia)
                    llenaralmacendest(bTransferencia)
    ...
    End Sub
    Private Sub llenaralmacenorigen(btrans As Boolean)
        Dim lCmd As New SqlClient.SqlCommand
        Dim lSql As String
        Dim dt As New DataTable()
        ...
        End If
    End Sub
    Private Sub llenaralmacendest(bTrans As Boolean)
        Dim lCmd As New SqlClient.SqlCommand
        Dim lSql As String
        Dim dt As New DataTable()
        Dim dsalmacenes As New DataSet
        ...
        Else
            With lCmd
                .CommandType = CommandType.Text
                .CommandText = "Select * From ALMACENES WHERE NOMBRE like '%TEMPORAL%' OR NOMBRE LIKE '%GRASA%' AND ID_CTE=" & oIntroductor.ID_CLIENTE
                .Connection = Cnn
            End With
