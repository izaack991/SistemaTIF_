...
Public Class frmPROC_ViscerasVerdes
    ...
    Private Sub frmPROC_ViscerasVerdes_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_SALVISCVERDE_INTRODUCTOR"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTMARCADESTINO"
                lsTitulo = "CTE_SALVISCVERDE_DESTINO"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTCODPROD"
                lsTitulo = "PROD_VISCERAS_VERDES"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 1
        End Select
    ...
    Private Sub frmPROC_Sacrificio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'CARGA EL MOVIMIENTO DE ENTRADA DE VISCERAS VERDES
        oMovAlmacen = New clsMovimientoAlmacen(10)
        ...
        If Not goPermisosValidaciones.PesadaManual_ViscerasVerdes Then Me.txtPeso.ReadOnly = True
    ...
    Private Sub DespliegaProducto()
        ...
        If oProducto.ID_PROD <> "" Then
            If oProducto.ID_FAM <> 2 Then
                ...
                Me.txtNomProd.Text = ""
            Else
                If oProducto.ID_SFAM <> 2 Then
                    MessageBox.Show("El producto no pertenece a la subfamilia de visceras verdes.", gProyecto, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                    oProducto = New clsProductos(0)
                    Me.txtCodProd.Text = ""
                    Me.txtNomProd.Text = ""
                Else
