...
Public Class frmPROC_SalidaCajas
    ...
    Private Sub frmPROC_SalidaCajas_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        'If iPrimeraVez Then
    ...
    Private Sub frmPROC_SalidaCajas_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmPROC_SalidaCajas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Guardar()
        Try
            ...
            loMovimientoEntSalTMP.ID_PED = Me.txtidpedido.Text
    ...
    Private Sub DespliegaDatos_TMP()
        Try
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_TMP 13, " & oIntroductor.ID_ALM_CAJ.ToString & "," & oDestino.ID_CLIENTE & "," & "0" & "," & Me.txtidpedido.Text
            ...
            DsSacrificio2.SP_CONS_ENTSAL_X_MOVTO_TMP.Clear()
            da3.Fill(DsSacrificio2.SP_CONS_ENTSAL_X_MOVTO_TMP)
            Me.GridControl1.DataSource = da3
            da2.Dispose()
            lCmd.Dispose()
    ...
    End Sub
    Private Sub DespliegaDatosDET_TMP()
        Try
            Dim lCmd As New SqlClient.SqlCommand
            Dim lSql As String
            Dim dt As New DataTable()
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTODET_TMP 13, " & oIntroductor.ID_ALM_CAJ.ToString & ", " & oDestino.ID_CLIENTE
            ...
            Dim da2 As New SqlDataAdapter(lCmd)
            DsSacrificio.SP_CONS_ENTSAL_X_MOVTODET_TMP.Clear()
            da2.Fill(DsSacrificio.SP_CONS_ENTSAL_X_MOVTODET_TMP)
            ...
            Me.lblCanalesSalida.Text = "Cajas para la salida" & " (" & Me.DsSacrificio.SP_CONS_ENTSAL_X_MOVTODET_TMP.Rows.Count & ")"
    ...
    'Private Sub cmbProductos_SelectedValueChanged(sender As Object, e As EventArgs)
    ...
    Private Function Valida_CodBar() As Boolean
        Try
            ...
            If oCaja.PROCESADO = "S" Then
                MessageBox.Show("Esta caja no esta disponible para la salida.", gProyecto, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.txtCodBar.SelectAll()
                Me.txtCodBar.Focus()
                Exit Function
            End If
            ...
            If oCaja.ID_ALM <> oIntroductor.ID_ALM_CAJ Then
                MessageBox.Show("Esta caja no pertenece al almacen proporcionado para la salida.", gProyecto, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.txtCodBar.SelectAll()
                Me.txtCodBar.Focus()
                Exit Function
            End If
    ...
    Private Sub AgregarCaja()
        Try
            ...
            loCajaTMP.ID_PED = Me.txtidpedido.Text
