...
Public Class frmPROC_Salida_Pieles
    ...
    Private Sub frmPROC_Salida_Pieles_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_SALPRODPIEL_INTRODUCTOR"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTMARCADESTINO"
                lsTitulo = "CTE_SALPRODPIEL_DESTINO"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTCODPROD"
                lsTitulo = "PROD_SALIDA_PIEL"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 1
        End Select
    ...
    Private Sub frmPROC_Salida_Pieles_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'CARGA EL MOVIMIENTO SALIDA DE PIELES POR EMBARQUE
        oMovAlmacen = New clsMovimientoAlmacen(11)
        ...
        If Not goPermisosValidaciones.PesadaManual_SalidaPieles Then Me.txtPeso.ReadOnly = True
    ...
    Private Sub DespliegaProducto()
        ...
        If oProducto.ID_PROD <> 0 Then
            If oProducto.ID_FAM <> 4 Then
                MessageBox.Show("El producto no pertenece a la familia de pieles.", gProyecto, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    ...
    End Sub
        ...
        Try
            ...
            loMovimientoEntSalTMP.ID_ALM = oIntroductor.ID_ALM_PIEL
    ...
    Private Sub AgregarProducto()
        Try
            ...
            loProductoTMP.ID_ALM = oIntroductor.ID_ALM_PIEL
            loProductoTMP.ID_ALM_DEST = oDestino.ID_ALM_PIEL
            ...
            loProductoTMP.SAC_LOTE = 0 'Me.txtLote.Text.Trim
    ...
    Private Sub DespliegaDatos_TMP()
        Try
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_PRODUCTOS_TMP 11, " & oIntroductor.ID_ALM_PIEL.ToString & ", " & oDestino.ID_CLIENTE
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_PRODUCTOS_RESUMEN_TMP 11, " & oIntroductor.ID_ALM_PIEL.ToString & ", " & oDestino.ID_CLIENTE
