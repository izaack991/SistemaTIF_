...
Public Class frmPROC_SalidaCanales_xID
    ...
    Private Sub frmPROC_SalidaCanales_xID_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        If iPrimeraVez Then
    ...
    Private Sub frmPROC_SalidaCanales_xID_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    End Sub
    Private Sub frmPROC_SalidaCanales_xID_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Guardar()
        Try
            ...
            loMovimientoEntSalTMP.ID_ALM = oDestino.ID_ALM_CAN
    ...
    Private Sub DespliegaDatos_TMP()
        Try
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_TMP 8, " & oIntroductor.ID_ALM_CAN.ToString & ", " & oDestino.ID_CLIENTE
    ...
    Private Sub AgregarCanal(Optional ByVal aPeso As String = "")
        Try
            If oCanal.ID_ESD = 0 Then
    ...
    Private Sub Valida_y_Agrega_Canal()
            ...
            For i = 0 To Me.lstID.Items.Count - 1
                ...
                If lCodBar.Trim <> "" Then
                    If Me.Valida_CodBar(lCodBar) Then
                        Me.txtPeso.Text = oCanal.PESO.ToString
                        Me.AgregarCanal()
