...
Public Class frmPROC_Salida_ViscerasDecomisos
    ...
    Private Sub frmPROC_Salida_ViscerasDecomisos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_DECVISCERA_INTRODUCTOR"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTMARCADESTINO"
                lsTitulo = "CTE_DECVISCERA_DESTINO"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 2
            Case "TXTCODPROD"
                lsTitulo = "PROD_SALIDA_VISCERAS_DEC"
                lsCampoBusqueda = "NOMBRE"
                liColumnaCodigo = 1
        End Select
    ...
    Private Sub frmPROC_Salida_ViscerasDecomisos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'CARGA EL MOVIMIENTO SALIDA VISCERAS POR DECOMISO
        oMovAlmacen = New clsMovimientoAlmacen(7)
        ...
        If Not goPermisosValidaciones.PesadaManual_SalidaViscerasDecomiso Then Me.txtPeso.ReadOnly = True
    ...
    Private Function ValidaDatos() As Boolean
        Try
            ...
            If Me.txtObservacionesDet.Text.Trim = "" Then
                MessageBox.Show("Debe proporcionar el motivo del decomiso.", gProyecto, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.txtObservacionesDet.Focus()
                Exit Function
            End If
    ...
    Private Sub AgregarProducto()
        Try
            ...
            loProductoTMP.OBSERVACIONES = Me.txtObservacionesDet.Text.Trim
    ...
    Private Sub DespliegaDatos_TMP()
        Try
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_PRODUCTOS_TMP 7, " & oIntroductor.ID_ALM_VIS.ToString & ", " & oDestino.ID_CLIENTE
            ...
            lSql = "EXECUTE SP_CONS_ENTSAL_X_MOVTO_PRODUCTOS_RESUMEN_TMP 7, " & oIntroductor.ID_ALM_VIS.ToString & ", " & oDestino.ID_CLIENTE
