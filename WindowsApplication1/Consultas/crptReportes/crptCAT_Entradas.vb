...
Public Class crptCAT_Entradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCAT_Entradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCAT_Entradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCAT_Entradas = New crptCAT_Entradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
