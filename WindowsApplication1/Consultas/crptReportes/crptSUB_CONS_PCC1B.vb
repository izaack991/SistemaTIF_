...
Public Class crptSUB_CONS_PCC1B
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptSUB_CONS_PCC1B.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptSUB_CONS_PCC1B
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptSUB_CONS_PCC1B = New crptSUB_CONS_PCC1B()
        rpt.Site = Me.Site
        Return rpt
    End Function
