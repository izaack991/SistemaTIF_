...
Public Class crptCAT_Productos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCAT_Productos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCAT_Productos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCAT_Productos = New crptCAT_Productos()
        rpt.Site = Me.Site
        Return rpt
    End Function
