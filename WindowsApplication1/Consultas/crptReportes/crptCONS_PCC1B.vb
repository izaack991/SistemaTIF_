...
Public Class crptCONS_PCC1B
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCONS_PCC1B.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCONS_PCC1B
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCONS_PCC1B = New crptCONS_PCC1B()
        rpt.Site = Me.Site
        Return rpt
    End Function
