...
Public Class crptCAT_TipoGanado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCAT_TipoGanado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCAT_TipoGanado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCAT_TipoGanado = New crptCAT_TipoGanado()
        rpt.Site = Me.Site
        Return rpt
    End Function
