...
Public Class crpt_VERICAR_CORTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crpt_VERICAR_CORTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_VERICAR_CORTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_VERICAR_CORTE = New crpt_VERICAR_CORTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
