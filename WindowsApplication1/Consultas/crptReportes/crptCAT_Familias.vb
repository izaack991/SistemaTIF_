...
Public Class crptCAT_Familias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCAT_Familias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCAT_Familias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCAT_Familias = New crptCAT_Familias()
        rpt.Site = Me.Site
        Return rpt
    End Function
