...
Public Class crptINV_Cajas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptINV_Cajas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptINV_Cajas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptINV_Cajas = New crptINV_Cajas()
        rpt.Site = Me.Site
        Return rpt
    End Function
