...
Public Class crptCAT_Especies
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCAT_Especies.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCAT_Especies
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCAT_Especies = New crptCAT_Especies()
        rpt.Site = Me.Site
        Return rpt
    End Function
