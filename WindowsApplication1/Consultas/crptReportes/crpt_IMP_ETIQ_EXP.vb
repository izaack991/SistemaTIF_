...
Public Class crpt_IMP_ETIQ_EXP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crpt_IMP_ETIQ_EXP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_IMP_ETIQ_EXP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_IMP_ETIQ_EXP = New crpt_IMP_ETIQ_EXP()
        rpt.Site = Me.Site
        Return rpt
    End Function
