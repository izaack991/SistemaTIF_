...
Public Class crpt_IMP_ETIQ_PROD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crpt_IMP_ETIQ_PROD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_IMP_ETIQ_PROD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_IMP_ETIQ_PROD = New crpt_IMP_ETIQ_PROD()
        rpt.Site = Me.Site
        Return rpt
    End Function
