...
Public Class crptREP_EstudioCorte
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crptREP_EstudioCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptREP_EstudioCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptREP_EstudioCorte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptREP_EstudioCorte = New crptREP_EstudioCorte()
        rpt.Site = Me.Site
        Return rpt
    End Function
