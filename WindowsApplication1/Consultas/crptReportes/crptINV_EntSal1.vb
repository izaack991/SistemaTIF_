...
Public Class crptINV_EntSal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptINV_EntSal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptINV_EntSal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptINV_EntSal = New crptINV_EntSal()
        rpt.Site = Me.Site
        Return rpt
    End Function
