...
Public Class crptMP_NATURAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptMP_NATURAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptMP_NATURAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptMP_NATURAL = New crptMP_NATURAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
