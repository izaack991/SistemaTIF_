...
Public Class crptINV_Canales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptINV_Canales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptINV_Canales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptINV_Canales = New crptINV_Canales()
        rpt.Site = Me.Site
        Return rpt
    End Function
