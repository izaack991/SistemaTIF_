...
Public Class crptPedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptPedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptPedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptPedidos = New crptPedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
