...
Public Class crpt_MEJORADO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crpt_MEJORADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_MEJORADO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_MEJORADO = New crpt_MEJORADO()
        rpt.Site = Me.Site
        Return rpt
    End Function
