...
Public Class frmCONS_Pieles


    Private Sub frmCONS_Pieles_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmCONS_Pieles_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CargaProductos()
    End Sub
