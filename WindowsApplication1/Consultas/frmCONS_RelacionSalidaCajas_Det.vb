...
Public Class frmCONS_RelacionSalidaCajas_Det

    Dim oIntroductor As New clsCliente


    Private Sub frmCONS_RelacionSalidaCajas_Det_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub DespliegaDatos()
        Try
            ...
            Me.DsCajas.SP_CONS_ENTSAL_RELACION_CAJAS_DET.Clear()

            lSql = "SP_CONS_ENTSAL_RELACION_CAJAS_DET '" & lCodAlmacen & "', 2, '" & Format(Me.dtpFechaIni.Value, "dd/MM/yyyy") & "', '" & Format(Me.dtpFechaFin.Value, "dd/MM/yyyy") & "', '%'" ', '" & Me.cmbProductos.SelectedValue & "' "
            ...
            da.Fill(Me.DsCajas.SP_CONS_ENTSAL_RELACION_CAJAS_DET)
    ...
    Private Sub Imprimir()
        Try
            ...
            miReporte = CType(New crptREP_RelacionSalidasCajas_Det, ReportDocument)

            Dim frmReporte As New frmCRViewer
            frmReporte.MdiParent = Me.ParentForm
            frmReporte.crViewer.ReportSource = miReporte

            miReporte.SetDataSource(Me.DsCajas.Tables("SP_CONS_ENTSAL_RELACION_CAJAS_DET"))
