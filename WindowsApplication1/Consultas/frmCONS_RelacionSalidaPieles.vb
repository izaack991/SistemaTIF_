...
Public Class frmCONS_RelacionSalidaPieles

    Dim oIntroductor As New clsCliente


    Private Sub frmCONS_RelacionSalidaPieles_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub DespliegaDatos()
        Try
            ...
            lSql = "SP_CONS_ENTSAL_PIELES_FECHA_ALMACEN '" & lCodAlmacen & "', 2, '" & Format(Me.dtpFechaIni.Value, "dd/MM/yyyy") & "', '" & Format(Me.dtpFechaFin.Value, "dd/MM/yyyy") & "'" ', '" & Me.cmbProductos.SelectedValue & "' "
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_RELSALPIELES_INTRODUCTOR"
