...
Public Class frmCONS_InventarioCanales
    ...
    Private Sub frmCONS_InventarioCanales_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        If iPrimeraVez Then
    ...
    Private Sub frmCONS_InventarioCanales_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_INVCANALES_INTRODUCTOR"
    ...
    Private Sub DespliegaDatos()
        Try
            ...
            If Me.chkTodos.Checked Then
                lCodAlm = "%"
            Else
                lCodAlm = oIntroductor.ID_ALM_CAN.ToString
            End If

            lSql = "SP_CONS_ENTSAL_ENCDET_X_ALMACEN_CANAL 2, '" & lCodAlm & "', '" & Me.cmbProductos.SelectedValue.ToString.Trim & "'"
    ...
    Private Sub Imprimir() '(aID_MOV As Integer, aID_ALM As Integer, aFolio As Integer)
        Try
            ...
            If DsSacrificio.SP_CONS_ENTSAL_ENCDET_X_ALMACEN_CANAL.Rows.Count = 0 Then
            ...
            miReporte = CType(New crptINV_Canales, ReportDocument)

            Dim frmReporte As New frmCRViewer
            frmReporte.MdiParent = Me.ParentForm
            frmReporte.crViewer.ReportSource = miReporte

            miReporte.SetDataSource(Me.DsSacrificio.Tables("SP_CONS_ENTSAL_ENCDET_X_ALMACEN_CANAL"))
