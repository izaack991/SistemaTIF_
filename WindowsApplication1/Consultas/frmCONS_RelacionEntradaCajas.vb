...
Public Class frmCONS_RelacionEntradaCajas

    Dim oIntroductor As New clsCliente


    Private Sub frmCONS_RelacionEntradaCajas_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub DespliegaDatos()
        Try
            ...
            lSql = "SP_CONS_ENTSAL_RELACION_CAJAS '" & lCodAlmacen & "', 1, '" & Format(Me.dtpFechaIni.Value, "dd/MM/yyyy") & "', '" & Format(Me.dtpFechaFin.Value, "dd/MM/yyyy") & "', '%'" ', '" & Me.cmbProductos.SelectedValue & "' "
