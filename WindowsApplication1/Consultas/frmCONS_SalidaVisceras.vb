...
Public Class frmCONS_SalidaVisceras

    Dim oIntroductor As New clsCliente


    Private Sub frmCONS_SalidaVisceras_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub DespliegaDatos()
        Try
            ...
            lSql = "SP_CONS_ENTSAL_VISCERAS_FECHA_ALMACEN '" & lCodAlmacen & "', 2, '" & Format(Me.dtpFechaIni.Value, "dd/MM/yyyy") & "', '" & Format(Me.dtpFechaFin.Value, "dd/MM/yyyy") & "'" ', '" & Me.cmbProductos.SelectedValue & "' "
    ...
    Private Sub Buscar()
        ...
        Select Case Me.ActiveControl.Name.TrimEnd.ToUpper
            Case "TXTMARCAINTRODUCTOR"
                lsTitulo = "CTE_RELSALVISCERAS_INTRODUCTOR"
