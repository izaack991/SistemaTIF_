...
Public Class crptCAT_Clientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaControlProduccion.crptCAT_Clientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCAT_Clientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCAT_Clientes = New crptCAT_Clientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
